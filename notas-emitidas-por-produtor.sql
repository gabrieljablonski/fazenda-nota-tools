select 
  ...
  (select COUNT(*) from Nfpe as n where n.issuedById = p.id and n.status = 'SENT' and DATE(n.issuedOn) > '2023-12-31') as '2024',
  (select COUNT(*) from Nfpe as n where n.issuedById = p.id and n.status = 'CANCELLED' and DATE(n.issuedOn) > '2023-12-31') as 'Canceladas 2024',
